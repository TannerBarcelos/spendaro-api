...
// This table is used to store simple user_id of the user via a webhook event callout from Clerk
export const users = pgTable("users", {
  user_id: text("user_id").primaryKey().unique().notNull(), // unique user id generated by the auth provider - Clerk handle all auth data - this data is just for the app (like profile iamge, etc.)
});
